plugins { id("com.android.application"); id("com.google.gms.google-services"); id("dev.flutter.flutter-gradle-plugin"); id("org.jetbrains.kotlin.android") }
...
signingConfigs { create("localDebug") { storeFile = file("local-debug.keystore"); storePassword = "android"; keyAlias = "localdebug"; keyPassword = "android" } }
buildTypes { getByName("debug") { signingConfig = signingConfigs.getByName("localDebug") }; release { if (hasLvlloReleaseSigning) { signingConfig = signingConfigs.create("lvlloRelease").apply { storeFile = file(lvlloKeystorePath!!); storePassword = lvlloKeystorePassword; keyAlias = "lvllo_release"; keyPassword = lvlloKeyPassword } } else { signingConfig = signingConfigs.getByName("localDebug") } } } }
