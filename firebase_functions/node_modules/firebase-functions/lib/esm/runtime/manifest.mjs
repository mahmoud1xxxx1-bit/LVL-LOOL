...
* @internal
*/
const globalManifest = globalSymbols[GLOBAL_MANIFEST_SYMBOL];
/**
* Clears all entries from the shared global manifest.
* @internal
*/
function clearGlobalManifest() {
...
//#endregion
export { clearGlobalManifest, globalManifest, initTaskQueueTrigger, initV1Endpoint, initV1ScheduleTrigger, initV2Endpoint, initV2ScheduleTrigger, stackToWire };